...
class AfegirAmics extends StatefulWidget {
  @override
  State<AfegirAmics> createState() => _AfegirAmicsState();
}

class _AfegirAmicsState extends State<AfegirAmics> {
  static List<String> llista_usuaris = [
    'extrany1',
    'jaume',
    'oriol',
    'maira',
  ...
  List<String> display_list = List.from(llista_usuaris);
